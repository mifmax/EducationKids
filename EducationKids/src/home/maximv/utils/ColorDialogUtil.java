package home.maximv.utils;
	...
	public class ColorDialogUtil extends View {
	        Paint paint;
	        Shader luar;
	        ...
	        public ColorDialogUtil(Context context, AttributeSet attrs) {
	                this(context, attrs, 0);
	        }


	        public ColorDialogUtil(Context context, AttributeSet attrs, int defStyle) {
